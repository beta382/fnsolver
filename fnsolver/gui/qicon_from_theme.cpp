...
QIcon qicon_from_theme(ThemeIcon iconName) {
#if QT_VERSION < QT_VERSION_CHECK(6, 7, 0)
  static std::unordered_map<ThemeIcon, QString> theme_icons{
    ...
    {ThemeIcon::HelpFaq, QStringLiteral("help-faq")},
    ...
    {ThemeIcon::SoftwareUpdateAvailable, QStringLiteral("software-update-available")},
    {ThemeIcon::SoftwareUpdateUrgent, QStringLiteral("software-update-urgent")},
  ...
  return QIcon::fromTheme(theme_icons.at(iconName));
#else
